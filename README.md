...
1. 教科書第9章「ウェブアプリケーション」 [補足資料](https://github.com/taroyabuki/webbook/blob/master/chapters/09.md)
1. ♠[放送大学教材「Webのしくみと応用」サポートサイト](https://github.com/taroyabuki/techappweb)
1. 小テスト
1. 演習
...
教科書3.5.1項を参照しながら作業する．ただし，p.72 脚注7の「W3C Validation」は使わない．

課題：構文の誤りを含むウェブページ https://taroyabuki.github.io/webbook/bunkasai.html がある．このページの構文エラーを修正する．ただし，ページの見た目を大きく変えてはいけない．

1. ウェブページのソースを確認する．
1. https://validator.w3.org で構文をチェックする．ここでは二つの方法を試す．
    1. 「Validate by URI」でURLを入力してチェックする．
    1. 「Validate by Direct Input」でソースコードを直接入力してチェックする．
